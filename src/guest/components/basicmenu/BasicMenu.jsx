...
//register user
  ...
  const [dsignup, setDSignup] = React.useState(false);
  ...
  return (
    <div className={Styles.menu}>
      ...
      >
        ...
        <MenuItem onClick={DSignupOpen}>D Sign Up</MenuItem>

        {/* <MenuItem onClick={SignupdOpen}>Sign Up Designer</MenuItem> */}
      </Menu>
      <Dialog
        open={login}
      ...
      <Dialog
        ...
        aria-describedby="alert-dialog-slide-description"
        maxWidth='md'
        PaperProps={{style: {width:'3000px',  height:'5000px',    backgroundColor: 'transparent',   boxShadow: 'none', }}}
      > <RegisterDesigner/>
